...
let
  ...
  # Add the runtime directories after init.lua because of a Neovim bug that
  # can source filetype plugins prematurely:
  # https://github.com/neovim/neovim/issues/19008
  # Prepend the main config, but append after/ so its overrides run last.
  + ''
